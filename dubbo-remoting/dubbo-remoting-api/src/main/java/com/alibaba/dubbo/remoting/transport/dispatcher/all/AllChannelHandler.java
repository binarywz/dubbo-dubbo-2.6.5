...
public class AllChannelHandler extends WrappedChannelHandler {
    ...
    /**
     * 处理请求和响应消息，这里的message变量类型可能是Request，也可能是Response
     * @param channel
     * @param message
    ...
    public void received(Channel channel, Object message) throws RemotingException {
        ...
        try {
            /**
             * 将请求和响应消息派发到线程池中处理
             * {@link com.alibaba.dubbo.remoting.transport.dispatcher.ChannelEventRunnable#run}
             */
        	...
        	if(message instanceof Request && t instanceof RejectedExecutionException){
        		...
        		// 若通信方式为双向通信，此时将'Server side ... threadpool is exhausted'错误信息封装到Response中，并返回给服务消费方
        		if(request.isTwoWay()){
