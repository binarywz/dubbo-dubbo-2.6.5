    ...
    private T createProxy(Map<String, String> map) {
        ...
        if (isJvmRefer) {
            ...
            if (urls.size() == 1) {
                ...
                for (URL url : urls) {
                    /**
                     * 通过refprotocol调用refer构建Invoker，refprotocol在运行时会根据
                     * url协议头加载指定的Protocol实例，并调用实例的refer方法
                     */
                ...
                if (registryURL != null) { // registry url is available
                    /**
                     * 若注册中心链接不为空，则使用AvailableCluster
                     */
